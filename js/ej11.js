...
let mayor = Math.max(age1, age2, age3);
  ...
  if(mayor===age1 && age1 === age2 && age1 === age3) {
    ...
    document.write(`los mayores son ${name1} y ${name2} que tienen ${age1} de edad`);
  }else if(mayor === age1 && age1 === age3 ) {
    document.write(`los mayores son ${name1} y ${name3} que tienen ${age1} de edad`);
  }else if (mayor === age2 && age2 === age3) {
    document.write(`los mayores son ${name2} y ${name3} que tienen ${age2} de edad`);
  }else if (mayor === age1) {
